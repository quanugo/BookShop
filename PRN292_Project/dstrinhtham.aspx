<%@ Page Title="" Language="C#" MasterPageFile="~/HomePage.Master" AutoEventWireup="true" CodeBehind="dstrinhtham.aspx.cs" Inherits="PRN292_Project.dstrinhtham" %>
...
<asp:Content ID="Content4" runat="server" contentplaceholderid="ContentPlaceHolder1">
    <div id="stsv-02">  <h3 class="tde" style="text-align:center"><span>Trinh thám</span></h3></div>
