<%@ Page Title="" Language="C#" MasterPageFile="~/HomePage.Master" AutoEventWireup="true" CodeBehind="searchresult.aspx.cs" Inherits="PRN292_Project.searchresult" %>
...
<asp:Content ID="Content4" runat="server" contentplaceholderid="ContentPlaceHolder1">
    <div id="stsv-02">  <h3 class="tde" style="text-align:center"><span>Kết quả</span></h3></div>
